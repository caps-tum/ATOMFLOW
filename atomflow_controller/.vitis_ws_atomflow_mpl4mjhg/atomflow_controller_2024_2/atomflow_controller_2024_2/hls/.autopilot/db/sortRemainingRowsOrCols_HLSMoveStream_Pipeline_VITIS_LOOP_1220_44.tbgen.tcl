set moduleName sortRemainingRowsOrCols_HLSMoveStream_Pipeline_VITIS_LOOP_1220_44
set isTopModule 0
...
set cdfgNum 72
set C_modelName {sortRemainingRowsOrCols<HLSMoveStream>_Pipeline_VITIS_LOOP_1220_44}
...
dict set ap_memory_interface_dict elbow2_colSelection { MEM_WIDTH 16 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ iter_1_reload int 5 regular  }
	{ end_colSelection_2 int 16 regular {array 16 { 1 3 } 1 1 }  }
	{ elbow2_colSelection int 16 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "iter_1_reload", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "elbow2_colSelection", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ iter_1_reload sc_in sc_lv 5 signal 0 } 
	{ end_colSelection_2_address0 sc_out sc_lv 4 signal 1 } 
	{ end_colSelection_2_ce0 sc_out sc_logic 1 signal 1 } 
	{ end_colSelection_2_q0 sc_in sc_lv 16 signal 1 } 
	...
	{ elbow2_colSelection_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "elbow2_colSelection_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "elbow2_colSelection", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	elbow2_colSelection { ap_memory {  { elbow2_colSelection_address0 mem_address 1 4 }  { elbow2_colSelection_ce0 mem_ce 1 1 }  { elbow2_colSelection_we0 mem_we 1 1 }  { elbow2_colSelection_d0 mem_din 1 16 } } }
}

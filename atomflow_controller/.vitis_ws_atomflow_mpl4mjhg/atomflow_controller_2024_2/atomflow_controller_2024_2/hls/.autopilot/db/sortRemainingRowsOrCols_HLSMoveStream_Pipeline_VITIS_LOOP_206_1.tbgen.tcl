set moduleName sortRemainingRowsOrCols_HLSMoveStream_Pipeline_VITIS_LOOP_206_1
set isTopModule 0
...
set cdfgNum 72
set C_modelName {sortRemainingRowsOrCols<HLSMoveStream>_Pipeline_VITIS_LOOP_206_1}
...
set C_modelArgList {
	{ sext_ln1270 int 15 regular  }
	{ shift_end int 18 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln1270", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "shift_end", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln1270 sc_in sc_lv 15 signal 0 } 
	{ shift_end sc_in sc_lv 18 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1270", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "sext_ln1270", "role": "default" }} , 
 	{ "name": "shift_end", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "shift_end", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sext_ln1270 { ap_none {  { sext_ln1270 in_data 0 15 } } }
	shift_end { ap_none {  { shift_end in_data 0 18 } } }

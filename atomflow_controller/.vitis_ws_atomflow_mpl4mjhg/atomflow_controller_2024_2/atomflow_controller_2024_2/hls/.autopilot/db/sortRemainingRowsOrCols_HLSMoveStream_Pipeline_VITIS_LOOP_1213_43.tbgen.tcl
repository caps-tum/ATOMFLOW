set moduleName sortRemainingRowsOrCols_HLSMoveStream_Pipeline_VITIS_LOOP_1213_43
set isTopModule 0
...
set cdfgNum 72
set C_modelName {sortRemainingRowsOrCols<HLSMoveStream>_Pipeline_VITIS_LOOP_1213_43}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict start_colSelection_2 { MEM_WIDTH 16 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ start_colSelection_2 int 16 regular {array 16 { 1 3 } 1 1 }  }
	{ elbow1_colSelection int 16 regular {array 16 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "iter_1_reload", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "start_colSelection_2", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ start_colSelection_2_address0 sc_out sc_lv 4 signal 1 } 
	{ start_colSelection_2_ce0 sc_out sc_logic 1 signal 1 } 
	{ start_colSelection_2_q0 sc_in sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "start_colSelection_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "start_colSelection_2", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	start_colSelection_2 { ap_memory {  { start_colSelection_2_address0 mem_address 1 4 }  { start_colSelection_2_ce0 mem_ce 1 1 }  { start_colSelection_2_q0 mem_dout 0 16 } } }
	elbow1_colSelection { ap_memory {  { elbow1_colSelection_address0 mem_address 1 4 }  { elbow1_colSelection_ce0 mem_ce 1 1 }  { elbow1_colSelection_we0 mem_we 1 1 }  { elbow1_colSelection_d0 mem_din 1 16 } } }
}

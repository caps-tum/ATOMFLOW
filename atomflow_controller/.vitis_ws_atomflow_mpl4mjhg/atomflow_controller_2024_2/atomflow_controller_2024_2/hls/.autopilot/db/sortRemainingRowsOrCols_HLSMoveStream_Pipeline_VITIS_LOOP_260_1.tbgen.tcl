set moduleName sortRemainingRowsOrCols_HLSMoveStream_Pipeline_VITIS_LOOP_260_1
set isTopModule 0
...
set cdfgNum 72
set C_modelName {sortRemainingRowsOrCols<HLSMoveStream>_Pipeline_VITIS_LOOP_260_1}
...
dict set ap_memory_interface_dict usedSourceIndices_data { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ sext_ln1269 int 18 regular  }
	{ trunc_ln15 int 16 regular  }
	{ zext_ln620_1 int 16 regular  }
	{ unusableInfo_usableAtoms_data int 32 regular {array 65536 { 1 3 } 1 1 }  }
	{ usedSourceIndices_data int 16 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln1269", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln15", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "usedSourceIndices_data", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln1269 sc_in sc_lv 18 signal 0 } 
	{ trunc_ln15 sc_in sc_lv 16 signal 1 } 
	...
	{ usedSourceIndices_data_address0 sc_out sc_lv 8 signal 4 } 
	{ usedSourceIndices_data_ce0 sc_out sc_logic 1 signal 4 } 
	{ usedSourceIndices_data_we0 sc_out sc_logic 1 signal 4 } 
	{ usedSourceIndices_data_d0 sc_out sc_lv 16 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1269", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "sext_ln1269", "role": "default" }} , 
 	{ "name": "trunc_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "trunc_ln15", "role": "default" }} , 
 	...
 	{ "name": "usedSourceIndices_data_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "usedSourceIndices_data", "role": "we0" }} , 
 	{ "name": "usedSourceIndices_data_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "usedSourceIndices_data", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	sext_ln1269 { ap_none {  { sext_ln1269 in_data 0 18 } } }
	trunc_ln15 { ap_none {  { trunc_ln15 in_data 0 16 } } }
	...
	usedSourceIndices_data { ap_memory {  { usedSourceIndices_data_address0 mem_address 1 8 }  { usedSourceIndices_data_ce0 mem_ce 1 1 }  { usedSourceIndices_data_we0 mem_we 1 1 }  { usedSourceIndices_data_d0 mem_din 1 16 } } }
}

set moduleName emissions_to_statearray_Pipeline_VITIS_LOOP_342_1
set isTopModule 0
...
set cdfgNum 72
set C_modelName {emissions_to_statearray_Pipeline_VITIS_LOOP_342_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict stateArray_data_s { MEM_WIDTH 1 MEM_SIZE 25000 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ i_145 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "i_145", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i_145 sc_in sc_lv 64 signal 0 } 
	{ stateArray_data_s_address1 sc_out sc_lv 15 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "i_145", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "i_145", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "25002"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "25002"}
]}
...
set Spec2ImplPortList { 
	i_145 { ap_none {  { i_145 in_data 0 64 } } }

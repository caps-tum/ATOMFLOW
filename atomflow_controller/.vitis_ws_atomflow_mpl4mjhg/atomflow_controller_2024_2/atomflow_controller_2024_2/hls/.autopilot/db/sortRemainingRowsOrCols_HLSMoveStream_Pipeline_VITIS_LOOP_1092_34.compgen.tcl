...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { usableBackBuf_address0 { O 4 vector } usableBackBuf_ce0 { O 1 bit } usableBackBuf_we0 { O 1 bit } usableBackBuf_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub1013_i \
    op interface \
    ports { sub1013_i { I 16 vector } } \
} "
}

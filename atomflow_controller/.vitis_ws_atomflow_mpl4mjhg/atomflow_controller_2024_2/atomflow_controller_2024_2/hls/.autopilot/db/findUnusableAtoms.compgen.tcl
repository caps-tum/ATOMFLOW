...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler atomflow_controller_am_submul_9ns_15ns_15s_15_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { targetGeometry_data_s_address0 { O 15 vector } targetGeometry_data_s_ce0 { O 1 bit } targetGeometry_data_s_q0 { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stateArray_cols_val { I 15 vector } } \
} "
}

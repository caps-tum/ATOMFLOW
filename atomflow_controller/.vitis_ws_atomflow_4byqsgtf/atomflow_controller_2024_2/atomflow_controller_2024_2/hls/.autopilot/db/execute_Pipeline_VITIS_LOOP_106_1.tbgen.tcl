set moduleName execute_Pipeline_VITIS_LOOP_106_1
set isTopModule 0
...
set cdfgNum 72
set C_modelName {execute_Pipeline_VITIS_LOOP_106_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "count_assign", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ count_assign sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "count_assign", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "count_assign", "role": "default" }} , 
...
set Spec2ImplPortList { 
	count_assign { ap_none {  { count_assign in_data 0 8 } } }

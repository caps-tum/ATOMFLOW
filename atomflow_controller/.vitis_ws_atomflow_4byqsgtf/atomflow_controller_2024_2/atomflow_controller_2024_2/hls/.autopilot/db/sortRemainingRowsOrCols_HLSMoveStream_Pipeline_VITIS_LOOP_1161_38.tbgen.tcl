set moduleName sortRemainingRowsOrCols_HLSMoveStream_Pipeline_VITIS_LOOP_1161_38
set isTopModule 0
...
set cdfgNum 72
set C_modelName {sortRemainingRowsOrCols<HLSMoveStream>_Pipeline_VITIS_LOOP_1161_38}
...
dict set ap_memory_interface_dict tempUsableH { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ zext_ln1161 int 5 regular  }
	{ zext_ln620_1 int 16 regular  }
	{ select_ln1161 int 17 regular  }
	{ unusableInfo_usableAtoms_data int 32 regular {array 65536 { 1 3 } 1 1 }  }
	{ tempUsableH int 32 regular {array 256 { 0 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln1161", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln620_1", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln1161", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "unusableInfo_usableAtoms_data", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "tempUsableH", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln1161 sc_in sc_lv 5 signal 0 } 
	{ zext_ln620_1 sc_in sc_lv 16 signal 1 } 
	{ select_ln1161 sc_in sc_lv 17 signal 2 } 
	...
	{ tempUsableH_address0 sc_out sc_lv 8 signal 4 } 
	{ tempUsableH_ce0 sc_out sc_logic 1 signal 4 } 
	{ tempUsableH_we0 sc_out sc_logic 1 signal 4 } 
	{ tempUsableH_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln1161", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln1161", "role": "default" }} , 
 	{ "name": "zext_ln620_1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "zext_ln620_1", "role": "default" }} , 
 	{ "name": "select_ln1161", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "select_ln1161", "role": "default" }} , 
 	...
 	{ "name": "tempUsableH_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tempUsableH", "role": "we0" }} , 
 	{ "name": "tempUsableH_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "tempUsableH", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	zext_ln1161 { ap_none {  { zext_ln1161 in_data 0 5 } } }
	zext_ln620_1 { ap_none {  { zext_ln620_1 in_data 0 16 } } }
	select_ln1161 { ap_none {  { select_ln1161 in_data 0 17 } } }
	...
	tempUsableH { ap_memory {  { tempUsableH_address0 mem_address 1 8 }  { tempUsableH_ce0 mem_ce 1 1 }  { tempUsableH_we0 mem_we 1 1 }  { tempUsableH_d0 mem_din 1 32 } } }
}

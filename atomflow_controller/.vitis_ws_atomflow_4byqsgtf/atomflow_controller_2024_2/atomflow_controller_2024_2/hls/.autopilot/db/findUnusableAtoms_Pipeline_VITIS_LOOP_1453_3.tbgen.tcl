...
set C_modelArgMapList {[ 
	{ "Name" : "empty_151", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mul_i", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stateArray_data_s_address0 sc_out sc_lv 10 signal 2 } 
	...
	{ mul_i sc_in sc_lv 10 signal 24 } 
	{ empty sc_in sc_lv 10 signal 25 } 
	{ targetGeometry_data_s_address0 sc_out sc_lv 10 signal 26 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_i", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "mul_i", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_i { ap_none {  { mul_i in_data 0 10 } } }

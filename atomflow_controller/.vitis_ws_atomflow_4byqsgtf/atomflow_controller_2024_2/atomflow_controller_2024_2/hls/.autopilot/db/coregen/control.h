...
#define CONTROL_BITS_MODE_DATA                  8
#define CONTROL_ADDR_EMISSION_THRESHOLD_DATA    0x18
#define CONTROL_BITS_EMISSION_THRESHOLD_DATA    32
#define CONTROL_ADDR_ATOMLOCATIONSSIZE_DATA     0x20
#define CONTROL_BITS_ATOMLOCATIONSSIZE_DATA     32
#define CONTROL_ADDR_PROJSHAPE0_DATA            0x28
#define CONTROL_BITS_PROJSHAPE0_DATA            32
#define CONTROL_ADDR_PROJSHAPE1_DATA            0x30
#define CONTROL_BITS_PROJSHAPE1_DATA            32
#define CONTROL_ADDR_ATOMLOCATIONS_DATA         0x38
#define CONTROL_BITS_ATOMLOCATIONS_DATA         64
#define CONTROL_ADDR_PSFSUPERSAMPLE_DATA        0x44
#define CONTROL_BITS_PSFSUPERSAMPLE_DATA        32
#define CONTROL_ADDR_IMAGEPROJECTIONSIZE_DATA   0x4c
#define CONTROL_BITS_IMAGEPROJECTIONSIZE_DATA   32
#define CONTROL_ADDR_IMAGEPROJS_LOCAL_DATA      0x54
#define CONTROL_BITS_IMAGEPROJS_LOCAL_DATA      64
#define CONTROL_ADDR_IMAGEPROJS_DATA            0x60
#define CONTROL_BITS_IMAGEPROJS_DATA            64
#define CONTROL_ADDR_IMAGEPROJS_LOCAL_SIZE_DATA 0x6c
#define CONTROL_BITS_IMAGEPROJS_LOCAL_SIZE_DATA 64
#define CONTROL_ADDR_FULLIMAGE_DATA             0x78
#define CONTROL_BITS_FULLIMAGE_DATA             64
#define CONTROL_ADDR_FULLIMAGE_ROWS_DATA        0x84
#define CONTROL_BITS_FULLIMAGE_ROWS_DATA        32
#define CONTROL_ADDR_FULLIMAGE_COLS_DATA        0x8c
#define CONTROL_BITS_FULLIMAGE_COLS_DATA        32
#define CONTROL_ADDR_EMISSIONS_DATA             0x94
#define CONTROL_BITS_EMISSIONS_DATA             64
#define CONTROL_ADDR_GRID_ROWS_DATA             0xa0
#define CONTROL_BITS_GRID_ROWS_DATA             32
#define CONTROL_ADDR_GRID_COLS_DATA             0xa8
#define CONTROL_BITS_GRID_COLS_DATA             32
#define CONTROL_ADDR_TARGETGEOMETRY_MEM_DATA    0xb0
#define CONTROL_BITS_TARGETGEOMETRY_MEM_DATA    64
#define CONTROL_ADDR_COMPZONEROWSTART_DATA      0xbc
#define CONTROL_BITS_COMPZONEROWSTART_DATA      32
#define CONTROL_ADDR_COMPZONEROWEND_DATA        0xc4
#define CONTROL_BITS_COMPZONEROWEND_DATA        32
#define CONTROL_ADDR_COMPZONECOLSTART_DATA      0xcc
#define CONTROL_BITS_COMPZONECOLSTART_DATA      32
#define CONTROL_ADDR_COMPZONECOLEND_DATA        0xd4
#define CONTROL_BITS_COMPZONECOLEND_DATA        32
#define CONTROL_ADDR_MOVECOUNT_DATA             0xdc
#define CONTROL_BITS_MOVECOUNT_DATA             32
#define CONTROL_ADDR_MOVECOUNT_CTRL             0xe0

...
set C_modelArgList {
	{ stateArray_data_s int 1 regular {array 1024 { 1 3 } 1 1 }  }
	{ stateArray_cols_val int 10 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stateArray_data_s", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "stateArray_cols_val", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stateArray_cols_val sc_in sc_lv 10 signal 1 } 
	...
	{ targetGeometry_data_s_address0 sc_out sc_lv 10 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stateArray_cols_val", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "stateArray_cols_val", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.am_submul_9ns_10ns_10s_10_4_1_U585", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	stateArray_data_s { ap_memory {  { stateArray_data_s_address0 mem_address 1 10 }  { stateArray_data_s_ce0 mem_ce 1 1 }  { stateArray_data_s_q0 mem_dout 0 1 } } }
	stateArray_cols_val { ap_none {  { stateArray_cols_val in_data 0 10 } } }
